...
namespace Zofe\Rapyd\Support;

/**
 * ISO 3166-1 alpha-2 country codes with English names, and the EU membership
 * used by the tax rules. Names from ibericode/vat (MIT).
 */
final class Countries
{
    ...
    {
        return $code !== null && in_array(strtoupper($code), self::EU, true);
    }
}
