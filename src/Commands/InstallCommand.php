...
class InstallCommand extends Command
{
    ...
    protected function injectUserTraits(Filesystem $files): void
    {
        ...
        $traits = ['HasUuids', 'HasRoles', 'Authorize', 'Limit', 'Impersonate', 'ShortId', 'SSearch'];
    ...
    protected function printTraitInstructions(): void
    {
        ...
        $this->line('    use Zofe\Rapyd\Traits\ShortId;');
        $this->line('    use Zofe\Rapyd\Traits\SSearch;');
        $this->line('');
        $this->line('  <fg=cyan>Trait uses inside the class body:</>');
        $this->line('    use HasUuids, HasRoles, Authorize, Limit, Impersonate, ShortId, SSearch;');
        $this->line('');
    }
